...
def test_identify_risk_and_mitigating_factors_boundaries():
    ...
    context2 = {**context, "filters_detected": ["html_entity_encoding"], "encoding_detected": "url_encoding"}
...
def test_generate_recommendations_by_severity_and_context():
    ...
    rec_high = ra.generate_recommendations(SeverityLevel.HIGH, context_js, ["data exfiltration"], [])
    ...
    rec_med = ra.generate_recommendations(SeverityLevel.MEDIUM, context_html, ["session hijacking"], [])
