...
def test_generated_payload_validation():
    with pytest.raises(ValueError):
        GeneratedPayload(payload="", context_type="html_content", evasion_techniques=[], effectiveness_score=0.5)
    with pytest.raises(ValueError):
        GeneratedPayload(payload="x", context_type="html_content", evasion_techniques=[], effectiveness_score=2.0)
    ok = GeneratedPayload(payload="x", context_type="html_content", evasion_techniques=None, effectiveness_score=0.5)
